...
- A Core-Hour Billing Token. Please see the [Compute: Licensing & Billing](../core-hour-billing#setting-up-core-hour-billing) to get a token.
...
1. Optional: Install yak-cli to install 3rd party packages.
