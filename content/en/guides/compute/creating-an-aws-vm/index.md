...
type = "guides"
weight = 3
override_last_modified = "2026-03-02T13:16:19Z"
...
1. From the EC2 console dashboard, int the **Launch instance** pane, select **Launch Instance**.

1. Under the **Names and tags** section, enter a name for the VM instance. For this tutorial, we'll use the name **"RhinoComputeVM"**.

1. Under the **Application and OS Images** section, click on the **Windows** button under the Quick Start tab. Under the Amazon Machine Image (AMI) section there should be a drop-down menu listing all of the available machine images. Select the AMI for **Microsoft Windows Server 2025 Base**.</p>
{{< image url="/images/AWS_Setup_16.png" alt="/images/AWS_Setup_16.png" class="image_left" width="100%" >}}

1. In the **Instance Type** section, select the **t3.micro** instance type (default) or a larger instance type if needed. Note: the *t3.micro* instance type is elegible for the free tier.</p>
{{< image url="/images/AWS_Setup_17.png" alt="/images/AWS_Setup_17.png" class="image_left" width="100%" >}}

1. In the **Key Pair (login)** section, for **Key pair name**, choose an existing key pair or choose **Create new key pair** to create your first key pair.</p>
{{< image url="/images/AWS_Setup_18.png" alt="/images/AWS_Setup_18.png" class="image_left" width="100%" >}}
...
{{< image url="/images/AWS_Setup_19.png" alt="/images/AWS_Setup_19.png" class="image_left" width="100%" >}}
