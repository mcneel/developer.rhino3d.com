+++
aliases = ["/en/5/guides/rhinocommon/plugin-user-data/", "/en/6/guides/rhinocommon/plugin-user-data/", "/en/7/guides/rhinocommon/plugin-user-data/", "/en/wip/guides/rhinocommon/plugin-user-data/"]
authors = [ "steve" ]
