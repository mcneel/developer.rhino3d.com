...
```cs
[System.Runtime.InteropServices.Guid("D48B1A0B-5C13-4C3B-A8D5-E1CF5920B65A")]
public class SpriteDrawingCommand : Rhino.Commands.Command
{
  public override string EnglishName { get { return "cs_spritedrawing"; } }

  bool m_draw_single_sprite;
  float m_sprite_size = 30;
  bool m_draw_world_location = true;
  ...
  Rhino.Display.DisplayBitmapDrawList m_items;
  ...
  Rhino.Display.DisplayBitmap m_sprite;
