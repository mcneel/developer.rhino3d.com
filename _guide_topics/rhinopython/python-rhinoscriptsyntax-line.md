...
When adding geometry to Rhino, Rhinoscript will return and Object ID from the drawn object.  Saving this ID in a variable allows it to be used later to select and manitpulate the object. 
